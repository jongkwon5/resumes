...
const introduce: IIntroduce.Payload = {
  ...
  content2:
    '배움과 도전에 주저하지 않는 개발자입니다. 저는 전반적인 CS 기초 지식을 습득하기 위해 학원 수업과 병행하며 정보처리기사, SQLD 자격증을 취득하였으며, 현재는 REST API 설계에 필요한 기본 지식을 학습하고 이를 활용한 개발 프로젝트를 준비하고 있습니다. 이러한 노력을 통해 업무의 속도와 효율성을 향상하며 동시에 유지보수성을 높이고 이를 통해 라임컴퍼니의 성장에 기여하고자 합니다.',
  content3:
