...
const introduce: IIntroduce.Payload = {
  ...
  content1:
    '지난 2년 동안 모교에서 4개 학과, 총 300여 명의 학생의 학사 업무를 담당하며 커뮤니케이션을 통한 업무 해결 능력을 키웠습니다. 이를 바탕으로 학원 팀 프로젝트에서 적극적으로 의견 조율 및 소통을 이끌어가며 기간 내 프로젝트를 완성할 수 있었습니다. 이토록 결과는 혼자서 만드는 것이 아닌, 모두의 노력이 필요하다고 생각하기에 팀 구성원들과 적극적으로 커뮤니케이션하며 협업하고자 합니다.',
  content2:
